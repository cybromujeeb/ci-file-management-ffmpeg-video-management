...
<body>
    ...
    <section class="container">
        <h1>Manage Video
            <?php echo pathinfo($video->video_path, PATHINFO_FILENAME).'.'.pathinfo($video->video_path, PATHINFO_EXTENSION);?>
        </h1>
        <div class="container">
          ...
          if(!empty($notifications)): ?>
            ...
            <div class="row">
                <form onsubmit="return validate($(this))" id="convert_form"
                    action="<?php echo site_url('video/convert');?>" method="POST">
                    <div class="col-sm-4">
                        <?php
              ...
              if(in_array('video',explode("/",$filetype))):?>
                        ...
                        <div class="col-md-8" id="appendels">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="form-inline"> From: <input class="form-control" type="time"
                                            name="start_time[]" step="1" value="00:00:00" required="" /></label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label class="form-inline">To: <input class="form-control" type="time"
                                            name="end_time[]" step="1" value="00:00:10" required="" /></label>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <a href="#" class="btn btn-sm btn-primary" onclick="addtabs()"><span
                        ...
                        <div class="col-sm-12">
                            <div class="col-md-8 pull-right">
                                ...
                                <div class="col-md-2 pull-right">
                                    <button id="submit" tyupe="submit" name="submit" class="btn btn-sm btn-success">Cut
                                        the video</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <hr />
                        <div class="col-md-8 pull-right">
                            <a href="<?php echo site_url('/video');?>" class="btn btn-sm btn-primary">Show all
                                videos</a>
                            <a href="<?php echo site_url('/video/new');?>"
                                class="btn btn-sm btn-warning pull-right">Upload new video</a>
                        </div>
                    </div>
            </div>
            </form>
